...
class SmallPost extends StatefulWidget {
  const SmallPost({super.key});

  @override
  State<SmallPost> createState() => _SmallPostState();
}

class _SmallPostState extends State<SmallPost> {
